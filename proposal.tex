...
\documentclass[10pt,a4paper,oneside]{report} \usepackage{graphicx}
\usepackage{lscape} \usepackage{float}
\begin{document}
...
% Here we have the last page in landscape, with the chart.
\begin{landscape}
\begin{center}
\hspace*{-1.5in}
\vspace*{-1.5in}
\section*{Work plan}
% We don't have the chart yet.
